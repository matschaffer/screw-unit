Screw.Stub = (function() {
    ...
    var shouldReceive = function(obj, name) {
        ...
        private.argsMatch = function(actual, expected) {
          return (typeof(expected) === 'function' && typeof(actual) === 'function') ||
                 (actual === expected);
        };
        ...
        self.accepts = function(args) {
            if (!private.expectedArguments) {
                ...
                for (var i=0; i < args.length; i++) {
                    if (!private.argsMatch(args[i], private.expectedArguments[i])) {
                        return false;
                    }
                };
                return true;
